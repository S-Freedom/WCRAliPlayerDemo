...
+ (void)getWithUrlString:(NSString *)urlString
    ...
    [[self manager] GET:string parameters:@{} headers:nil progress:^(NSProgress * _Nonnull downloadProgress) {
...
#warning 尊敬的客户，此Server服务只用于demo演示使用，我们不建议您将此演示接口用作线上环境，请自行搭建自己的Server服务，如何集成自己的Server服务详见文档：https://help.aliyun.com/document_detail/108783.html?spm=a2c4g.11186623.6.1075.a70a3a4895Qysq。
    ...
    [[self manager] POST:urlString parameters:mutableParaDic headers:nil progress:^(NSProgress * _Nonnull uploadProgress) {
